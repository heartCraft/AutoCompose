...
public class AssembleEngine implements AssembleCarParts {

    @Autowired
    private MakeEngine makeEngine;
    ...
    public Boolean syncExecute() {
        if (makeEngine.getExecuteResult() == null || makeCarFrame.getExecuteResult() == null) {
            return false;
        }
        // log
